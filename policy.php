...
<div class="container">
    ...
    <ol>
        <li>程式碼 <p>本站為開放原始碼專案之實例，所運行之程式碼除設定檔外本站保證與開源倉庫版本相同而未經其他更改。程式碼貢獻、合併與其他相關操作準用開源社群習慣，其審核皆經嚴格審視。</p></li>
        ...
        <li>經費來源<p>本平台之經費由網站負責人及其他社會人士無條件捐助。本平台承諾不會在任何時間向您收取任何費用。由於本專案之公益與無償性質，其維運與更新仰賴社會資助與社群熱情。本平台歡迎社會人士與法人捐助，惟其不得帶有除用途外之任何交換條件以確保本服務之公平與公正性。</p></li>

        <li>經費使用<p>本平台承諾經費之使用僅限於網站之維運與更新，或用於工作人員因此所必須之開銷，絕不會挪用至其他用途。</li>

        <li>服務內容變更<p>無論暫時性或永久性、無論是否先行通知使用者，由於本平台之無償性質所致之不穩定性，本平台保有修改或停用服務之權利。本平台並不需要因為服務內容的修改或停用而對您或任何第三方負責。並且，本平台保有在任何時候，無論是否先行通知使用者，都保有修改、調整、新增或刪除本合約內容之權利。</p></li>
