...
<div class="container">
    ...
    <ol>
        ...
        <li>資料之保護
            <ul>
                ...
                <li>如因業務需要有必要委託其他單位提供服務時，本網站亦會嚴格要求其遵守保密義務，並且採取必要檢查程序以確定其將確實遵守。<br /><br /></li>
            </ul>
        </li>
    ...
    <ol>
        <li>程式碼 <p>本站為開放原始碼專案之實例，所運行之程式碼除設定檔外本站保證與開源倉庫版本相同而未經其他更改。程式碼貢獻、合併與其他相關操作準用開源社群習慣，其審核皆經嚴格審視。<br /><br /></p>
        </li>
        ...
        <li>其他
            <ol>
                <li>本頁所寫政策將因應法規修訂或其他環境、需求變遷等因素而為適當修改，以落實保障您的隱私權益。修正後之條款將立即公告於本網站。 <br /><br /></li>
