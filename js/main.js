if (!sessionStorage.popup) {
    ...
    Swal.fire({
        ...
        title: '回復營運聲明',
        width:'90%',
        html: '<p>親愛的使用者：</p><p>由於持續受到政府與企業單位關切，原專案發起人不堪其擾，故於西元 2019 年 10 月 23 日正式將本專案移轉至香港商 Starlight Systems Company 公司（下稱本公司）。</p><p>為專案發起人承諾之個人資料安全之主張，實現個資不離地，且顧及當前香港情勢，故本公司將台灣區訂閱之個人資料轉交至 台灣數位串流有限公司（下稱合作公司） 負責。並基於促進公眾利益之出發點，本站將持續提供免費無償之查詢服務。</p><p>另為了保障各位使用者的個人資料安全，轉移採用資料庫不移轉方針，包括但不限於訂閱名單的所有資料庫內容皆不會移轉至新服務內，若需繼續訂閱可使用本網站所新增之續訂頁面，讓使用者能無縫轉移至新服務上。使用該續訂頁面，即代表您（使用者）同意舊有團隊將您的信箱地址、姓名與身分證末六碼之雜湊值及姓名（用於信件內稱謂）提供予本公司作為訂閱信件寄送用途。</p><p>另在此再次聲明，後續服務之供大眾查詢之內容皆為本公司所判斷、查核，並新增至系統，概與舊有團隊與合作公司無關，敬請各位使用者繼續支持本專案。</p><p>此致</p><p>Starlight Systems Company 專案營運經理</p><p>台灣數位串流有限公司 專案營運經理</p><p>20xx 年 xx 月 xx 日</p>'
    });
}
