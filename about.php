    ...
    <div class="container">
        ...
        <p>本專案為「108 年度教育部資訊安全人才培育計畫－新型態資安暑期課程 AIS3 2019 資安實務專題競賽」成果之延伸。<br/>本專案之開發與維護於「AIS3 2019 資安實務專題競賽結束後」，皆為自主、獨立之行為，未受任何單位指派或委託，專案開發之進程可於 <a href="https://github.com/seadog007/breach.tw">GitHub</a> 中瀏覽。</p>
        ...
        <p>若想匿名提供資源，可聯絡 <a href="mailto:admin@breach.tw">admin@breach.tw</a>，建議使用 PGP Key <a href="https://pgp.key-server.io/pks/lookup?op=get&fingerprint=on&search=0xF85EC40BC49D4040">C49D4040</a> 進行加密。</p>
